...
public class TestTopologyWebservice extends AbstractTopologyTest {
	...
	public final void testAddDeleteLink() throws Exception {
		...
		this.deleteLink(this.link.getSourceEndpoint(),
				this.link.getDestinationEndpoint());
	}
	...
	public final void testAddEditDeleteDomain() throws Exception {
		...
		for (final DomainInformationType domain : this.getDomains()
			...
			if (editedDtt != null) {
				if (editedDtt.getDomainSupportedAdaptation().get(0)
						.equals(dtt.getDomainSupportedAdaptation().get(0))
						&& editedDtt
								.getDomainSupportedBandwidth()
								.get(0)
								.equals(dtt.getDomainSupportedBandwidth()
										.get(0))
						&& editedDtt
								.getDomainSupportedSwitchMatrix()
								.get(0)
								.equals(dtt.getDomainSupportedSwitchMatrix()
										.get(0))) {
					technologyOk = true;
				}
			}
