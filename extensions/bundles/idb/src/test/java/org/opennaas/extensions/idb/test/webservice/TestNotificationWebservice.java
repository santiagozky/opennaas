...
public class TestNotificationWebservice extends AbstractNotificationTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		TestNotificationWebservice.domainInfoType
				.setDomainId("NotificationTestDomain");
		TestNotificationWebservice.domainInfoType.setReservationEPR(Helpers
				.getRandomString());
	...
	public final void setUp() throws Exception {
		this.topic = new NotificationTopic(
				TestNotificationWebservice.domainInfoType.getDomainId(), 666);
	...
	private SubscribeResponseType subscribe(final SubscribeType req)
		...
		Assert.assertTrue("Subscribe was not successfull!", response.isResult());
		return response;
	}
	...
	public final void testNotificationWorkflow() throws Exception {
		...
		Assert.assertTrue("addTopic-Response should be true",
				addTopicResponse.isResult());
		...
		Assert.assertTrue("notify-Response should be true",
				NotifyResponse.isResult());
		System.out.println(" passed!");
	...
	private UnsubscribeResponseType unsubscribe(final UnsubscribeType req)
		...
		Assert.assertTrue("Unsubscribe was not successfull!",
				response.isResult());
		return response;
	}
}
