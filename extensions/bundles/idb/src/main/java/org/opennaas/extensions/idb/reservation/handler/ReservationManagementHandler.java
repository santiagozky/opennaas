...
public final class ReservationManagementHandler {
	...
	private final Log logger = LogFactory
			.getLog(ReservationManagementHandler.class);
	...
	public GetReservationResponseType getReservation(
		...
		final Reservation reservation = Reservation.load(element
				.getReservationID());
		if (reservation == null) {
			throw new InvalidReservationIDFaultException("reservation "
	...
	public GetReservationsResponseType getReservations(
		...
		for (final Reservation reservation : reservations) {
			...
			complexType.setReservationID(WebserviceUtils
					.convertReservationID(reservation.getReservationId()));
	...
	private List<ServiceConstraintType> getServices(final long resID,
		...
		for (final Service service : services) {
			responseList.add(this.createServiceConstraintType(service,
