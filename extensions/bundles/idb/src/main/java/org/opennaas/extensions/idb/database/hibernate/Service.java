...
public class Service implements java.io.Serializable {
	...
	public Service getCopy() {
		Service result = new Service(this.getServiceId(),
				this.getReservation(), this.serviceType, this.getStartTime(),
				this.getDeadline(), this.getDuration(),
	...
	public void loadConnections() throws DatabaseException {
		...
		for (Connections connections : tmpConns) {
			this.getConnections().put(
					new Integer(connections.getConnectionId()), connections);
		}
	...
	public void addConnection(Connections connection) {
		...
		this.getConnections().put(new Integer(connection.getConnectionId()),
				connection);
	}
	...
	public String getDebugInfo() {
		...
		for (Connections conn : this.getConnections().values()) {
