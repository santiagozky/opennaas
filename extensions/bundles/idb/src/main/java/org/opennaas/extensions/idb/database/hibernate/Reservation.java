...
public class Reservation implements java.io.Serializable {
	...
	public Reservation getCopy() {
		Reservation copy = new Reservation(this.getReservationId(),
				this.getConsumerUrl(), this.getTimeout(), this.getJobId());
		for (Service s : getServices().values()) {
			copy.addService(s);
		}
		return copy;
	...
	public int compareTo(Reservation resParam) {
		if (this.getReservationId() < resParam.getReservationId()) {
			return -1;
		} else if (this.getReservationId() == resParam.getReservationId()) {
			return 0;
		} else {
			return 1;
		}
	...
	public CreateReservationType toJaxb() {
		...
		if (this.getGri() != null) {
			createReservationType.setGRI(this.getGri());
		}

		if (this.getToken() != null) {
			createReservationType.setToken(this.getToken());
		}
