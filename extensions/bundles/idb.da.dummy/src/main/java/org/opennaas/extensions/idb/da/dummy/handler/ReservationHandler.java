...
public final class ReservationHandler extends CommonReservationHandler {
	...
	private ServiceConstraintType createTestService() {
		...
		final FixedReservationConstraintType fixedConstraints = new FixedReservationConstraintType();
	...
	public GetReservationsResponseType getReservations(
		...
		final GetReservationsResponseType responseType = new GetReservationsResponseType();

		/* create a simple answer without any meaning ----------------------- */
		final GetReservationResponseType rsvType = new GetReservationResponseType();
	...
	public IsAvailableResponseType isAvailable(final IsAvailableType request) {
		...
		final ConnectionAvailabilityType detailedResult = new ConnectionAvailabilityType();
