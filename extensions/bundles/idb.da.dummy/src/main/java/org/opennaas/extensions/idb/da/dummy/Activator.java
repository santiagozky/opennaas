...
public class Activator extends AbstractActivator implements BundleActivator {
	 ...
	 * @throws ActivatorException
	 */
	public static IActionSet getDummyAdapterActionSetService(String name,
			String version) throws ActivatorException {

		try {
			log.debug("Calling Dummy Adapter ActionSetService");
			return (IActionSet) getServiceFromRegistry(context,
					createFilterL2BoDActionSet(name, version));
		} catch (InvalidSyntaxException e) {
			throw new ActivatorException(e);
		}
	}
	 ...
	 * @throws InvalidSyntaxException
	 */
	private static Filter createFilterL2BoDActionSet(String name, String version)
			throws InvalidSyntaxException {
