 ...
 * @author gassen
 */
public class AbstractFaultException extends RuntimeException {
	...
	private void setDetail(Element element) {
		this.detail = element;
	...
	private String stackTraceToXML(final Throwable ex) {
		String result = "<stackTrace " + "className=\""
				+ ex.getClass().getName() + "\">";

		for (StackTraceElement element : ex.getStackTrace()) {
			result += "<stackTraceElement " + "className=\""
