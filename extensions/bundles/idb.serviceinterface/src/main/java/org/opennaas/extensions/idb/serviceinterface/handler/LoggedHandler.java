...
public class LoggedHandler extends CachedHandler {
	...
	private static final synchronized Log getPerformanceLogger(
		...
		if (null == LoggedHandler.performanceLogger) {
			LoggedHandler.performanceLogger = LogFactory
					.getLog(LoggedHandler.class);
		}
	...
	protected final Log getLogger() {
		if (null == this.logger) {
			...
			this.logger = LogFactory.getLog(RequestHandler.class);
	 ...
	 *             In case of any runtime exceptions
	 */
	public final Log getPerformanceLogger() {
		Log result = null;
		try {
