 ...
 */
 public class TopologyClient extends WsResourceClient implements ITopologyClient {
    ...
    private static final String[] _METHOD_NAMES = {
        "addLink", "getEndpoints", "editDomain", "getLinks", "deleteEndpoint", "addOrEditDomain", "deleteLink", "getDomains", "addDomain", "addEndpoint", "editLink", "deleteDomain", "editEndpoint"
    };
    ...
    private static final String[] _ACTIONS = {
        "http://opennaas.org/nsp/webservice/topology/addLink", "http://opennaas.org/nsp/webservice/topology/getEndpoints", "http://opennaas.org/nsp/webservice/topology/editDomain", "http://opennaas.org/nsp/webservice/topology/getLinks", "http://opennaas.org/nsp/webservice/topology/deleteEndpoint", "http://opennaas.org/nsp/webservice/topology/addOrEditDomain", "http://opennaas.org/nsp/webservice/topology/deleteLink", "http://opennaas.org/nsp/webservice/topology/getDomains", "http://opennaas.org/nsp/webservice/topology/addDomain", "http://opennaas.org/nsp/webservice/topology/addEndpoint", "http://opennaas.org/nsp/webservice/topology/editLink", "http://opennaas.org/nsp/webservice/topology/deleteDomain", "http://opennaas.org/nsp/webservice/topology/editEndpoint"
    };

    private static final QName[] _REQUEST_NAMES = {
        new QName("http://opennaas.org/nsp/webservice/topology", "addLink", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "getEndpoints", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "editDomain", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "getLinks", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "deleteEndpoint", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "addOrEditDomain", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "deleteLink", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "getDomains", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "addDomain", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "addEndpoint", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "editLink", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "deleteDomain", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "editEndpoint", "pfx0")
    };

    private static final QName[] _RESPONSE_NAMES = {
        new QName("http://opennaas.org/nsp/webservice/topology", "addLinkResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "getEndpointsResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "editDomainResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "getLinksResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "deleteEndpointResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "addOrEditDomainResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "deleteLinkResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "getDomainsResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "addDomainResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "addEndpointResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "editLinkResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "deleteDomainResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/topology", "editEndpointResponse", "pfx0")
    };
