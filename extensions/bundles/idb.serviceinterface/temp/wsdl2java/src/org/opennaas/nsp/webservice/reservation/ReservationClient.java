 ...
 */
 public class ReservationClient extends WsResourceClient implements IReservationClient {
    ...
    private static final String[] _METHOD_NAMES = {
        "createReservation", "isAvailable", "bind", "activate", "getReservation", "notification", "cancelReservation", "cancelJob", "getStatus", "completeJob", "getReservations"
    };
    ...
    private static final String[] _ACTIONS = {
        "http://opennaas.org/nsp/webservice/reservation/createReservation", "http://opennaas.org/nsp/webservice/reservation/isAvailable", "http://opennaas.org/nsp/webservice/reservation/bind", "http://opennaas.org/nsp/webservice/reservation/activate", "http://opennaas.org/nsp/webservice/reservation/getReservation", "http://opennaas.org/nsp/webservice/reservation/notification", "http://opennaas.org/nsp/webservice/reservation/cancelReservation", "http://opennaas.org/nsp/webservice/reservation/cancelJob", "http://opennaas.org/nsp/webservice/reservation/getStatus", "http://opennaas.org/nsp/webservice/reservation/completeJob", "http://opennaas.org/nsp/webservice/reservation/getReservations"
    };

    private static final QName[] _REQUEST_NAMES = {
        new QName("http://opennaas.org/nsp/webservice/reservation", "createReservation", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "isAvailable", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "bind", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "activate", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "getReservation", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "notification", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "cancelReservation", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "cancelJob", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "getStatus", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "completeJob", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "getReservations", "pfx0")
    };

    private static final QName[] _RESPONSE_NAMES = {
        new QName("http://opennaas.org/nsp/webservice/reservation", "createReservationResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "isAvailableResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "bindResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "activateResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "getReservationResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "notificationResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "cancelReservationResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "cancelJobResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "getStatusResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "completeJobResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/reservation", "getReservationsResponse", "pfx0")
    };
