 ...
 */
 public class NotificationClient extends WsResourceClient implements INotificationClient {
    ...
    private static final String[] _METHOD_NAMES = {
        "removeTopic", "unsubscribe", "getTopics", "subscribe", "publish", "addTopic"
    };
    ...
    private static final String[] _ACTIONS = {
        "http://opennaas.org/nsp/webservice/notification/removeTopic", "http://opennaas.org/nsp/webservice/notification/unsubscribe", "http://opennaas.org/nsp/webservice/notification/getTopics", "http://opennaas.org/nsp/webservice/notification/subscribe", "http://opennaas.org/nsp/webservice/notification/publish", "http://opennaas.org/nsp/webservice/notification/addTopic"
    };

    private static final QName[] _REQUEST_NAMES = {
        new QName("http://opennaas.org/nsp/webservice/notification", "removeTopic", "pfx0"), new QName("http://opennaas.org/nsp/webservice/notification", "unsubscribe", "pfx0"), new QName("http://opennaas.org/nsp/webservice/notification", "getTopics", "pfx0"), new QName("http://opennaas.org/nsp/webservice/notification", "subscribe", "pfx0"), new QName("http://opennaas.org/nsp/webservice/notification", "publish", "pfx0"), new QName("http://opennaas.org/nsp/webservice/notification", "addTopic", "pfx0")
    };

    private static final QName[] _RESPONSE_NAMES = {
        new QName("http://opennaas.org/nsp/webservice/notification", "removeTopicResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/notification", "unsubscribeResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/notification", "getTopicsResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/notification", "subscribeResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/notification", "publishResponse", "pfx0"), new QName("http://opennaas.org/nsp/webservice/notification", "addTopicResponse", "pfx0")
    };
