package org.opennaas.events.tests;
...
import org.opennaas.tests.integration.helper.IntegrationTestsHelper;
...
public class SendReceiveEventsTest extends AbstractIntegrationTest {
	...
	public static Option[] configure() {
		return combine(IntegrationTestsHelper.getOpennaasOptions()
